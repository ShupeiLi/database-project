...
\begin{center}
	\includegraphics[height = 8cm]{e-r-e3.png}
\end{center}
...
候选码：Seller (\uline{Sno}, Sname, Saddress) 
...
候选码：Delivery (\uline{Dno}, Dvalue, Dtrans, Tno, Pno, Sno)
...
候选码：Transportation Company (\uline{Tno}, Tname)
...
候选码：Acceptance (\uline{Tno}, \uline{Pno}, Dpno)
...
候选码：Geography (\uline{Dno}, \uline{Dupdate}, Dloc, Pno)
...
候选码：Geography (\uline{Dno}, \uline{Dupdate}, Dloc, Zloc, Cno, Cupdate)
...
候选码：Pandemic (\uline{Cno}, \uline{Cupdate}, Cname, Cstate, Cloc)
...
候选码：Match2 (\uline{Cno}, \uline{Cupdate}, \uline{Pno}, \uline{Pupdate}, Zpeople)
...
候选码：Staff Health (\uline{Pno}, \uline{Pupdate}, Pcity, Ptemp)
