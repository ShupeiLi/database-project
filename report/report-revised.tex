...
对“人传人”的新冠疫情防护已步入常态化阶段，然而最近对新冠病毒“物传人”的担忧再起。北京市海淀区一居民购自内蒙古的物品，外包装被检测出阳性结果。11月10日，中国疾控中心专门针对外卖配送和快递从业人员发布了健康防护指南；中国疾控中心消毒学首席专家张流波在11月13日的国务院联防联控机制新闻发布会上建议，在收快递时做好适度防护，表面包装要求不带入室内或进行消毒，处理完快递后做好手卫生。\par 
...
\begin{center}
	\includegraphics[height = 15cm]{level-1.png}
\end{center}
...
\begin{center}
	\includegraphics[height = 15cm]{level-2.1.png}
\end{center}

\noindent \textbf{(2) 数据统计与可视化}
\begin{center}
	\includegraphics[height = 8cm]{level-2.2.png}
\end{center}
...
\noindent \textbf{(4) 查询信息 (电商平台)}
\begin{center}
	\includegraphics[height = 10cm]{level-2.4.png}
\end{center}

\noindent \textbf{(5) 获取物流信息报表}
\begin{center}
	\includegraphics[height = 8cm]{level-2.5.png}
\end{center}

\noindent \textbf{(6) 获取物流-疫情报表}
\begin{center}
	\includegraphics[height = 10cm]{level-2.6.png}
\end{center}
